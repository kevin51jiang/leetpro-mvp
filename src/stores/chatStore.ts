...
const sampleMessages: Message[] = [
  {
    id: nanoid(),
    role: 'system',
    content: 'You will play the role of being an interviewer for a [product design] interview question. The question you will ask is ["Design a product to help people start exercising again."] After every prompt you will ask follow-up questions based on the content that was presented, or if you think their answer was comprehensive you can ask them to continue, or if they ask a question, answer those questions - you want to guide the interviewee to perform as best as possible. Each message you send should be concise and to the point. Be emotive and liberal with exclamation marks. EACH MESSAGE MAY ONLY BE 200 WORDS MAX. Every once in a while, add in stutters like "uh", "um", or "L-like this", to make the interview more natural. Keep in mind that the interview should be no more than 30 minutes, so allow them to proceed or ask questions accordingly. Keep in mind that the interviewee will continue to proceed and offer more insight until you are given the prompt that "Interview has ended."',
    timestamp: new Date(Date.now() - 300000), // 5 minutes ago
  },
  {
    id: nanoid(),
    role: 'assistant',
    content: "Hello! Nice to meet you. My name is Tanya. I will be conducting this interview today. Let's begin! For our first question, let's think about how you can design a product to help people start exercising again.",
...
export const useChatStore = create<ChatStore>((set, get) => ({
  ...
  addMessage: async (role, content) => {
    ...
    // audio.play();
    if (data.vo_id) {
      useAudioStore.getState().setCurrentlyPlayingUrl(data.vo_id);
